...
class SalgPreFormViewModel @Inject constructor(
    ...
    var flatLayoutVisibility = MutableLiveData<Int>(View.GONE)

    var societyLayoutVisibility = MutableLiveData<Int>(View.VISIBLE)

    var selectFlathouseNumberEnabled = MediatorLiveData<Boolean>(true)
...
//        }
    ...
    var responseVisibility1 : LiveData<Int> = responseModel.map {
        if(it.equals("Rejected",true) || it.equals("Door was locked",true))
        {
            View.VISIBLE
        }
        else{
